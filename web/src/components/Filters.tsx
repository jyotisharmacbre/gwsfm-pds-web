...
import { Paper, Typography, makeStyles, createStyles, Theme, Grid, TextField, Container, MenuItem, FormControl, FormLabel, Divider, withStyles, InputLabel, Link } from '@material-ui/core';
                ...
                <ExpansionPanelDetails>
                    <Container component="main">
                        <form className={classes.form} noValidate onSubmit={handleSubmit}>
                            ...
                            <Box component="span" display={hide ? 'none' : 'block'} id="boxAdvanceSearch">
                                <Grid container spacing={3}>
                                    <Grid item xs={12} sm={4}>
                                        <InputLabel shrink className={classes.label}>
                                            Last updated
                                ...
                                <Grid item xs={4} sm={6} className='actions'>
                                    <Grid justify="space-between" container spacing={1}>
                                        <Grid item xs={4} sm={3} className='actions'>
                                            <Typography className={classes.label}>Advanced search</Typography>
                                        </Grid>
                                        <Grid item xs={4} sm={9} className='actions'>
                                            ...
                                            >
                                                {hide ? <AddOutlinedIcon className={classes.label} /> : <RemoveOutlinedIcon className={classes.label} />}
                                            </Link>
                                        </Grid>
                                    </Grid>
                                </Grid>

                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <form className="custom-wrap">
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="exampleInputEmail1">Existing Subcontractor</label>
                                        <div className="js-btn2">
                                            <button type="button">YES</button>
                                            <button className="active" type="button">NO</button>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label>Subcontractor</label>
                                        <input type="text" placeholder="Enter Subcontractor's Name" />
                                    </div>
                                    <div className="form-group">

...
import { Grid, FormControl, InputLabel, TextField, makeStyles, createStyles, Theme, RadioGroup, FormControlLabel, FormLabel, Radio, MenuItem } from '@material-ui/core';
...
const workTypes = [{ name: 'Select', value: '' }, { name: 'val 1', value: 'val1' }];

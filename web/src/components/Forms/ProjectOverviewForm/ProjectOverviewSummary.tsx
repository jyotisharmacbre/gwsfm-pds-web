...
const ProjectOverviewSummary: React.FC<IProps> = (props) => {
	...
	return (
		<div className="RS_custom_block">
			<h4><FormattedMessage id="TITLE_PROJECT_OVERVIEW" /></h4>
			<div className="RS_custom_inner">
				<div className="row">
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_MAIN_CONTRACTOR" /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_ENQUIRY_RECEIVED_FROM" /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_LIQUIDATED_DAMAGES" /></span>
				...
				<div className="row">
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_TYPE_OF_ENQUIRY" /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id='LABEL_WORK_TYPE' /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_CREDIT_CHECK_RESULT" /></span>
				...
				<div className="row">
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_INSURANCE" /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_SITE_ADDRESS" /></span>
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_FORM_OF_CONTRACT" /></span>
				...
				<div className="row">
					...
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_PROJECT_IS_LIVE" /></span>
								<p>{props.projectOverview.projectAdditionalDetail.isProjectLive ? formatMessage('LABEL_YES') : formatMessage('LABEL_NO')}</p>
							</li>
						</ul>
					</div>
					<div className="col-lg-4 col-sm-6">
						<ul>
							<li>
								<span><FormattedMessage id="LABEL_RETENTION" /></span>

...
describe('Preliminary Components Form test cases', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = shallow(
      <PreliminaryComponentsForm fields={initialState.preliminaryDetails} submitHandler={props.submitHandler}  handleSubmit={props.handleSubmit} onToggleEvent={props.onToggleEvent} prelimData={initialState.preliminaryDetails} />
    );
  });
